...
public abstract class Validation {
    ...
    protected abstract boolean contientTravailBureau(List<Projet> projetsDuJour) throws IOException;
    protected abstract boolean contientTeleTravail(List<Projet> projetsDuJour) throws IOException;
    protected abstract boolean contientCongeFerie(List<Projet> projetsDuJour) throws IOException;
    protected abstract boolean contientCongeMaladie(List<Projet> projetsDuJour) throws IOException;
    protected abstract boolean contientCongeVacances(List<Projet> projetsDuJour) throws IOException;
    protected abstract boolean contientCongeParental(List<Projet> projetsDuJour) throws IOException;
}
