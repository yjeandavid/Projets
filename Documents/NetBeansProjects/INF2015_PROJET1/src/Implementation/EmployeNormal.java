 ...
 * @author Michael
 */
public class EmployeNormal extends IEmploye {
    
    public EmployeNormal(JSONObject jsonObject)
    {
        noEmploye = jsonObject.getInt("numero_employe");
        message = "";
        minHeureDeBureauParJour = 
                Settings.MINIMUM_MINUTES_BUREAU_NORMAL_PAR_JOUR;
        minHeureDeBureauParSemaine =
                Settings.MINIMUM_MINUTES_BUREAU_NORMAL_SEMAINE;
